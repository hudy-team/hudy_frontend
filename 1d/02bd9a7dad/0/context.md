...
[Image: source: /Users/minkyu/Desktop/스크린샷 2026-02-16 오후 3.43.56.png]
...
⏺ hudy - get_holidays (MCP)(year: 2026)
  ⎿  Error: Not Found

⏺ 2026년 공휴일 데이터가 아직 등록되어 있지 않은 것 같습니다. 2025년 데이터를 확인해볼까요?

⏺ hudy - get_holidays (MCP)(year: 2025)
  ⎿  Error: Not Found
...
mcp 항목 추가. /v2/business-days/check api가 추가됐음. api 스펙은 옵셔널 파라미터인 day 가존재. day는 연월일을 전달하면, 해당 일자가 영업일인지 아닌지 제시해줌. 파라미터 안주면 현재날짜 기준으로 체크값을 응답함. 해당 추가된 코어 api 관련 mcp 항목 추가해서 커밋/푸시 진행
